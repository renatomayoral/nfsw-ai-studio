...
// ─── FAQ data ─────────────────────────────────────────────────────────────────
const FAQS = [
  { q: 'As páginas têm verificação de idade?', a: 'Sim. As páginas já vêm com selo 18+, prévias com cadeado e um card de destaque para a assinatura — feitas para criadoras de conteúdo premium, respeitando as regras de cada plataforma.' },
      ...
      <section id="recursos" style={{ maxWidth: 1180, margin: '0 auto', padding: '90px 24px 30px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(250px,1fr))', gap: 18, marginTop: 48 }}>
          {[
            ...
            { icon: <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#60a5fa" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>, bg: 'rgba(59,130,246,.12)', border: 'rgba(59,130,246,.25)', title: 'Pronto para conteúdo premium', desc: 'Selo de verificação de idade, prévias com cadeado e card de destaque para a assinatura. Tudo configurado para converter.' },
